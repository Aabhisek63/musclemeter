...
function ViewAdSuggestion() {
    ...
    async function allfeed() {
        ...
        var response=await fetch(`http://localhost:8080/feed/suggestion`);
...
<div className="col-10  col-md-5 p-5 bg-dark rounded-4 text-light mx-auto " >
        
    <div className="row">
    <h3 className='text-center text-shadow'>All Suggestions</h3>
