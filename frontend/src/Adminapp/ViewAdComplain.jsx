...
function ViewAdComplain() {
   ...
   //  var a=localStorage.getItem('user');
        ...
        var response=await fetch(`http://localhost:8080/feed/complain`);
...
<div className="col-10  col-md-5 p-5 bg-dark text-light rounded-4 mx-auto " >
        
    <div className="row">
    <h3 className='text-center text-shadow'>All Complains</h3>
