...
function ViewAdFeed() {
    ...
    async function allfeed() {
        ...
        var response=await fetch(`http://localhost:8080/feed/feedback`);
...
<div className="col-10  col-md-5 p-5 bg-dark rounded-4 mx-auto  text-light" >
        
    <div className="row">
    <h3 className='text-center text-shadow'>All Feedbacks</h3>
