...
const validate = ()=>{
 ...
 navigate('/Addash')
  ...
  const logcode=async(e)=>{
   ...
   var response=await fetch(`http://localhost:8080/userlog`,{
      method:"POST",
      headers:{
  ...
  return (
   ...
   <div className="row my-5">
    <div className="col-md-4 col-sm-7 mx-auto p-5 text-center">
        ...
        <p className='small'>Don't have an account?<Link to="/Signup" className='text-black fw-bold'>Sign Up</Link></p>
...
<i className={pa?"fa fa-eye-slash":"fa fa-eye"}  onClick={()=>{
 ...
 <br /> <br />
     ...
     <a href="" className='text-black fw-bold'>Forget Password</a>
